...
const MediaColorSize = ({ productId, mediaId, closeModal }) => {
  ...
  useEffect(() => {
    ...
    LoadMediaColorSize(selectedModel, mediaId);
  }, [selectedModel, mediaId]);
  ...
  const LoadMediaColorSize = (modelId, mediaId) => {
    modelAPI
