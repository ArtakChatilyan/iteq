...
import { AboutUsSeoData } from "../seotags/AboutUsSEO";
...
const AboutUs = () => {
  ...
  useEffect(() => {
    if (lang) setSeoData(AboutUsSeoData[lang]);
  }, [lang]);
  return (
    <>
      {seoData && (
        <Helmet key={lang}>
          ...
          <link
            rel="alternate"
            href="https://iteq.shop/en/about/"
            hrefLang="en"
          />
          <link
            rel="alternate"
            href="https://iteq.shop/ru/about/"
            hrefLang="ru"
          />
          <link
            rel="alternate"
            href="https://iteq.shop/ka/about/"
            hrefLang="ka"
          />
          <link
            rel="alternate"
            href="https://iteq.shop/about/"
            hrefLang="x-default"
          />
